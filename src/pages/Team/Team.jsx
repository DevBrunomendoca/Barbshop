    ...
    <ContainerTeam>
      ...
      <ContentTeam id='content-team-page'>
        ...
        <ContentCardTeam>
          ...
          <CardTeamPage id='card2' srcImg='/foto-barbeiro-perfil2.jpg' name='Lucas Teodoro' description='Matheus é conhecido pela sua dedicação ao profissionalismo e à satisfação do cliente. Com sua atenção aos detalhes e habilidades técnicas excepcionais, ele cria estilos que refletem a personalidade única de cada cliente.'/>

          <CardTeamPage id='card3' srcImg='/foto-barbeiro-perfil3.jpg' name='Lucas Teodoro' description='Pedro combina sua paixão pela arte da barbearia com um profissionalismo exemplar. Seu compromisso com a precisão e a perfeição garante resultados impressionantes em cada serviço. '/>

          <CardTeamPage id='card4' srcImg='/foto-barbeiro-perfil4.jpg' name='Lucas Teodoro' description='Daniel é reconhecido por sua ética de trabalho impecável e sua habilidade excepcional na cadeira de barbeiro. Com uma abordagem centrada no cliente e um compromisso inabalável com a qualidade, ele proporciona cortes de cabelo e barba que refletem o estilo e a personalidade de cada cliente.'/>
        </ContentCardTeam>
      </ContentTeam>
    </ContainerTeam>
  )
